...
async function seedOperations(vehicles, drivers) {
  ...
  const tripsData = [
    ...
    { tripNumber: 'TR-2026-008', vehicleId: getV('BUS-01'), driverId: getD('Sarah Connor'), source: 'Downtown', destination: 'Tech Park', cargoWeight: '1', plannedDistance: '25', actualDistance: '25', fuelConsumed: '5', status: 'completed', startedAt: new Date(Date.now() - 86400000 * 10), completedAt: new Date(Date.now() - 86400000 * 9) },
